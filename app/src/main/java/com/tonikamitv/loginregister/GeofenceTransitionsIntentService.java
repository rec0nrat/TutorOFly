...
import static com.tonikamitv.loginregister.Constants.CONNECTION_TIME_OUT_MS;
import static com.tonikamitv.loginregister.Constants.GEOFENCE_DATA_ITEM_PATH;
import static com.tonikamitv.loginregister.Constants.GEOFENCE_DATA_ITEM_URI;
import static com.tonikamitv.loginregister.Constants.KEY_GEOFENCE_ID;
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geoFenceEvent.hasError()) {
            ...
            if (Geofence.GEOFENCE_TRANSITION_ENTER == transitionType) {
                ...
                putDataMapRequest.asPutDataRequest();//HERE IS WHAT YOU CHANGED!!!
